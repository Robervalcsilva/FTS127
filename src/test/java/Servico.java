...
public class Servico {
    ...
    public void tc_02_consultar_usuario() throws IOException {
        ...
        given() // Dado que
                ...
                //.body(jsonBody)
                .when()
                .get("https://petstore.swagger.io/v2/user/AnaClaraRS")
                .then()
                .log().all()
                .statusCode(200) // Teste de Interoperabilidade (Conectou)
        //.body("code",is(200))
    ...
    public void tc_03_alterar_usuario() throws IOException {
        ...
        given() // Dado que
                ...
                .body(jsonBody)
                .when()
                .put("https://petstore.swagger.io/v2/user/AnaClaraRS")
                .then()
                .log().all()
                .statusCode(200) // Teste de Interoperabilidade (Conectou)
                .body("code", is(200))
    ...
    public void tc_04_excluir_usuario() throws IOException {
        ...
        given() // Dado que
                ...
                //.body(jsonBody)
                .when()
                .delete("https://petstore.swagger.io/v2/user/AnaClaraRS")
                .then()
                .log().all()
                .statusCode(200) // Teste de Interoperabilidade (Conectou)
        //.body("code",is(200))
